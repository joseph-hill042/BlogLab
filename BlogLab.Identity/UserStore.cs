...
namespace BlogLab.Identity
{
            ...
            IUserPasswordStore<ApplicationUserIdentity>
    {
        ...
        public async Task<ApplicationUserIdentity> FindByNameAsync(
            string normalizedUserName,
            CancellationToken cancellationToken
        )
        {
            return await _accountRepsoitory.GetByUsernameAsync(
                normalizedUserName,
                cancellationToken
            );
        }
        ...
        public Task<ApplicationUserIdentity> FindByEmailAsync(
        ...
        public Task<ApplicationUserIdentity> FindByIdAsync(
            string userId,
            CancellationToken cancellationToken
        )
        {
